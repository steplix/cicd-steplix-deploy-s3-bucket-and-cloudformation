...
const PostCard = ({ publishingAt, description, url }) => {
    ...
    return(
        <div className="bg-white shadow-post-card p-6 rounded-[20px] w-[279px] h-[310px] sm:w-[500px] sm:h-[226.38px] lg:w-[375.5px] lg:h-[260.4px] xl:w-[488.5px] xl:h-[223.19px] max-w-lg">
            ...
            <p className="text-grey-19 text-mobile mt-5 font-normal font-poppins">{description}</p>
