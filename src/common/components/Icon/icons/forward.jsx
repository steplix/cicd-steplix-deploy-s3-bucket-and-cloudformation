...
const forward = ({ className }) => (
    <Svg className={className} originalSize={41}>
        ...
        <path d="M23.1193 19.2809C23.6276 19.7892 23.6276 20.6109 23.1193 21.1192L19.2193 25.0192C18.711 25.5275 17.8895 25.5275 17.3812 25.0192C16.8729 24.5109 16.8729 23.6892 17.3812 23.1809L20.3621 20.2L17.3812 17.2192C16.8729 16.7109 16.8729 15.8892 17.3812 15.3809C17.6347 15.1274 17.9675 15 18.3003 15C18.6331 15 18.9658 15.1274 19.2193 15.3809L23.1193 19.2809Z" fill="#00A9E0"/>
        ...
        <defs>
        <filter id="filter0_d_1506_68375" x="1.44" y="1.44" width="38.8267" height="38.8267" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        ...
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1506_68375"/>
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1506_68375" result="shape"/>
        </filter>
        </defs>
    </Svg>
);
