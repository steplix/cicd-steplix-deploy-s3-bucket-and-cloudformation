...
const restart = ({ className }) => (
  <Svg className={className} originalSize={41}>
    ...
    <path d="M16 16.2L18.2 14M16 16.2L18.2 18.4M16 16.2H22.6C23.1835 16.2 23.7431 16.4318 24.1556 16.8444C24.5682 17.2569 24.8 17.8165 24.8 18.4V19.5M24.8 25L22.6 27.2M24.8 25L22.6 22.8M24.8 25H18.2C17.6165 25 17.0569 24.7682 16.6444 24.3556C16.2318 23.9431 16 23.3835 16 22.8V21.7" stroke="#00A9E0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <defs>
        <filter id="filter0_d_2060_108312" x="1.44" y="1.44" width="38.8267" height="38.8267" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
            ...
            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_2060_108312"/>
            <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2060_108312" result="shape"/>
        </filter>
    </defs>
  </Svg>
);
