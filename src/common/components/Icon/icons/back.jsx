...
const back = ({ className }) => (
  <Svg className={className} originalSize={41}>
    ...
    <path
      d="M17.3816 21.1195C16.8733 20.6112 16.8733 19.7895 17.3816 19.2812L21.2816 15.3812C21.7899 14.8729 22.6115 14.8729 23.1198 15.3812C23.6281 15.8895 23.6281 16.7112 23.1198 17.2195L20.1389 20.2004L23.1198 23.1812C23.6281 23.6895 23.6281 24.5112 23.1198 25.0195C22.8663 25.273 22.5335 25.4004 22.2007 25.4004C21.8679 25.4004 21.5351 25.273 21.2816 25.0195L17.3816 21.1195Z"
      fill="#00A9E0"
    />
    <path
    ...
    <defs>
      ...
      >
        ...
        />
        <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1506_68393" />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_1506_68393"
          mode="normal"
          result="shape"
        />
      </filter>
