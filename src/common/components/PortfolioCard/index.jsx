  ...
  return (
    <div className='w-[280px] sm:w-[376px] h-[501px] xl:w-[488px] sm:h-[489px] xl:h-[489px] shadow-portfolio-card rounded-[20px] flex flex-col'>
      <picture className='w-full rounded-tl-[20px] rounded-tr-[20px] max-h-[259px]'>
        ...
        <img alt={t(`portfolio.cards.${name}.imageAlt`)} src={`/assets/img/portfolio/${name}.png`} className='w-full' />   
      </picture> 
      <div className='px-6 w-full h-full py-4 flex flex-col justify-center bg-white rounded-bl-[20px] rounded-br-[20px]'>
        ...
        <div className="mt-[48px] flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-4 items-center justify-center">
          ...
          <CustomNextLink to={`/${locale}/contact`}>
            <button aria-label={t("navbar.item4.ariaLabel")} className='flex space-x-1 items-center justify-center text-xs font-bold text-blue sm:text-white bg-white sm:bg-blue w-fit sm:px-2 sm:py-1 rounded-[20px]'>
