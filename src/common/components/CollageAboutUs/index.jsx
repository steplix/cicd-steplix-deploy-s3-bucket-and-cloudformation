            ...
            <div className="container flex justify-center">
                ...
                <div className="hidden md:flex space-x-5">
                    <div className="space-y-5">
                        <div className="relative md:w-[223px] md:h-[323px] lg:w-[301px] lg:h-[437px] xl:w-[296px] xl:h-[428px]">
                            <img
                                src="/assets/img/culture/culture-01.png"
                                alt="culture"
                            />
                        </div>
                        <div className="relative md:w-[223px] md:h-[144px] lg:w-[301px] lg:h-[195px] xl:w-[296px] xl:h-[191px]">
                            <img
