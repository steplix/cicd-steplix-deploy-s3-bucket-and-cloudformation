    ...
    return (
        <Fade cascade>
            <div className="container px-5 md:px-0" id="culture">
                <div id="our-culture" className="mb-10 xl:mt-14 text-left">
                    <p className="text-2xl md:text-3xl lg:text-5xl xl:text-3xl leading-6 xl:leading-10 font-medium xl:mb-2">
                        {t("ourCulture.title")}
                    </p>
                    <h2 className="mb-6 xl:mb-14 font-black text-2xl md:text-8xl lg:text-9xl xl:text-8xl">
                ...
                <div className="flex flex-col xl:flex-row space-y-10 xl:space-y-0 xl:space-x-20">
                    <FeatureCard
                        title={t("ourCulture.cardOne.title")}
                        description={t("ourCulture.cardOne.description")}
                        divideColor="bg-blue"
                        widthTitle="xl:w-[196px]"
