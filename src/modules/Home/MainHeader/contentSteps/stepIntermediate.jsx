...
const StepIntermediate = ({ cardInfo, stepPosition, dashLine}) => {
  ...
  return (
    <div className="relative">
      <div className={`absolute hidden sm:block cardStepAnimation ${dashLine.name} ${dashLine.position.top} ${dashLine.position.left} ${dashLine.size.width} ${dashLine.size.height}`}/>
