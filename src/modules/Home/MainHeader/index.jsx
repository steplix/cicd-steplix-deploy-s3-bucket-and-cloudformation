...
const MainHeader = () => {
  ...
  const [stepsByBreakpoint, setStepsByBreakpoint] = useState(
    MOUNTAIN_STEPS["xs"]
  );
  ...
  useEffect(() => {
    if (
      showStepIntermediate.one ||
      showStepIntermediate.two ||
      showStepIntermediate.three
    ) {
  ...
  return (
    <header className="relative overflow-x-hidden">
      ...
      {(stepsByBreakpoint[currentStep - 1].id === 2 ||
        showStepIntermediate.one) && (
      ...
      {(stepsByBreakpoint[currentStep - 1].id === 3 ||
        showStepIntermediate.two) && (
        <div className="container absolute top-[62px] sm:top-[72px]">
          <StepIntermediate
            cardInfo={{
      ...
      {(stepsByBreakpoint[currentStep - 1].id === 4 ||
        showStepIntermediate.three) && (
        <div className="container absolute top-[62px] sm:top-[72px]">
          <StepIntermediate
            cardInfo={{
      ...
      <div className="container absolute top-[417px] lg:top-[461.4px] xl:top-[440px]">
        <ScrollButton
          ...
          icon="back"
          scrollAction={() =>
            scrollLeft(stepsByBreakpoint[currentStep - 1].scrollSizePrevious)
          }
        ...
        <ScrollButton
          ...
          icon="forward"
          scrollAction={() =>
            scrollRight(stepsByBreakpoint[currentStep - 1].scrollSizeNext)
          }
          customClass={`${
            currentStep === 1 ? "float-left" : "float-right"
          } lg:z-20`}
