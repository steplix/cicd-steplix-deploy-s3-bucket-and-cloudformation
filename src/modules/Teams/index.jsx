    ...
    <section className="flex flex-col space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col gap-8 space-y-6 lg:space-y-0 lg:space-x-16 items-center lg:justify-center">
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 items-center justify-center">
          <div className="flex flex-row space-x-3 md:space-x-6">
            <Chip
              label={"QA"}
              name="qa"
              customIconClass="h-[18px] w-[18px] mt-2"
            />
            <Chip
              label={"UI/UX"}
              name="uiux"
              customIconClass="h-[18px] w-[18px]"
            />
            <Chip
              label={"Mobile"}
              name="mobile"
              customIconClass="h-[18px] w-[18px] text-white"
            />
          </div>
          <div className="flex flex-row space-x-3 md:space-x-6">
            <Chip
              label={"Front end"}
              name="frontend"
              customIconClass="h-[18px] w-[18px] mt-1"
            />
            <Chip
              label={"Back end"}
              name="backend"
        ...
        <h3 className="font-black text-[24px] text-purple mx-auto lg:mx-0">
          #Digital{" "}
          <span
            className="text-outlined--purple font-black"
      ...
      <p className="font-poppins text-sm lg:text-base font-normal text-black">
        ...
        <span className="font-semibold">
          {t("about_us.teams.descriptionBold")}
        </span>
      </p>
