                ...
                <Fade cascade>
                    <section className="container-steplix section-steplix pb-[53px] md:pb-[106px] lg:pb-[196px] xl:pb-[142px] 2xl:pb-[150px]">
                        ...
                        <p className="p-steplix text-center md:w-[735px] lg:w-[931px] xl:w-[1000px] 2xl:w-[1160px]">
                            ...
                            • Foundation • Tailwind • NodeJs • PHP • Java •
                            Python • Ruby • C • C++ • C# • GO • ASP.NET •
                            Express • Ember • Laravel • Symfony • CakePHP •
                            Django • Spring • Struts • Ruby on Rails • MySQL •
                            Mariadb • SQL • Sqlite • DynamoDB • PostgreSQL • DB2
                            • HSQLDB • redis • mongoDB • ElastiCache •
                            elasticSearch • Cordova • Ionic • Flutter • Kotlin •
                            Java • Objective-C • Swift • git • svn • Gitlab •
                            Github • Bitbucket • Vagrant • Docker • Kubernetes •
                            Linux • Windows • AWS • Azure • Firebase • WordPress
                            • ghost • Drupal
                        </p>
                    </section>
                </Fade>
