...
- **Components**:
  - `Carousel`: IsInfinite props added.
  - `PortfolioCard`: Zoom in/out animation added.
  - `PortfolioCarousel`: Adjustments in mobile to adapt the width of the carousel with the screen.
  - `Navbar`: Locale added to the link of the logo image.
